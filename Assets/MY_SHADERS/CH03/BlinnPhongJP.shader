Shader "Custom/BlinnPhongJP" {
	...
	SubShader {
		...
		{
			//Reflection, we first need to calculate whether our current pixel and the light are orthogonal
			float NdotL = max(0,dot(s.Normal,lightDir)); //This is where the reflection of the light would come from
